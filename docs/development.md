...
版本：v0.2 · 日期：2026-09-18 · 状态：开发设计，尚未实施；当前以本地开发和 VSIX 试用为交付目标
...
后续公开发布需要落实的身份信息：正式名称、GitHub 所有者/仓库、Marketplace publisher、最终许可证与发布账号授权。它们不阻塞脚手架、核心功能开发和本地 VSIX 验证。本轮仅更新与编写文档，没有创建远端仓库、上传文件或发布扩展。
